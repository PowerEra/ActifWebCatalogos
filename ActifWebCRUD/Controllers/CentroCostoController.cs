...
namespace ActifWebCRUD.Controllers
{
    public class CentroCostoController : Controller
    {
        ...
        public CentroCostoController(CookieAuthenticationService authService, ApplicationDbContext context)
        {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            if (user == null)
            {
                return View(new List<CentroCosto>());
            }

            // Use the VIEW for SELECT operations
            var centrosCosto = await _context.VCentroCosto
